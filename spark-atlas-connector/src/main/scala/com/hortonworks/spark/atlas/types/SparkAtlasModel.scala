...
object SparkAtlasModel extends Logging {
  ...
  val allTypes = Map(
    ...
    SPARK_TABLE_DB_RELATIONSHIP_TYPE_STRING -> SPARK_TABLE_DB_RELATIONSHIP_TYPE,
    SPARK_TABLE_COLUMNS_RELATIONSHIP_TYPE_STRING -> SPARK_TABLE_COLUMNS_RELATIONSHIP_TYPE,
    SPARK_TABLE_STORAGEDESC_RELATIONSHIP_TYPE_STRING -> SPARK_TABLE_STORAGEDESC_RELATIONSHIP_TYPE,
